# SpeakMate PWA 2.3.0 开发规格（历史归档，不适用于 3.0）

归档说明：下方正文保留旧版决策；其中路径以原项目根目录为基准，费用、服务与能力描述不作为当前承诺。新开发遵循 [3.0 规格](../../APP_SPEC.md)。
...
>
> 视觉基准：[`docs/design/speakmate-dialogue-stage-reference.png`](../design/speakmate-dialogue-stage-reference.png)
