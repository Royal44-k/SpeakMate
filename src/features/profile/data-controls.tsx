...
export function DataControls({
  ...
  return (
    <section className={styles.controls} aria-labelledby="data-title">
      ...
      <button type="button" className={styles.exportButton} onClick={() => void exportData()}><DownloadSimple aria-hidden size={20} />导出学习数据</button>
      <div className={styles.dangerZone}>
        ...
        <button type="button" disabled={confirmation !== '清空'} onClick={() => void clearData()}><Trash aria-hidden size={19} />永久清空本机数据</button>
      </div>
