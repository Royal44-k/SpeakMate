...
> 文档版本：2.3.0
>
> 状态：2.3.0 移动布局、搜索与对话流程修复；本次证据与发布记录见 `docs/releases/2.3.0-mobile-dialogue-repair.md`。下方 2.2.0 记录仅为历史基线，不代表本次验收。
>
> 更新日期：2026-09-09
>
...
2. 准备页展示场景背景、双方角色、任务目标、关键词与分层例句（去重后每场景每等级至少 5 条，上限 10 条），不再限制为两条固定句式。
3. 用户点击“开始角色对话”。
